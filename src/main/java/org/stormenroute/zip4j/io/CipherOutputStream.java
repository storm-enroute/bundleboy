...
import org.stormenroute.zip4j.crypto.AESEncrpyter;
import org.stormenroute.zip4j.crypto.IEncrypter;
import org.stormenroute.zip4j.crypto.StandardEncrypter;
...
public class CipherOutputStream extends BaseOutputStream {
	...
	public CipherOutputStream(OutputStream outputStream, ZipModel zipModel, byte bhash) {
	...
	private void createFileHeader() throws ZipException {
		this.fileHeader = new FileHeader(bhash);
